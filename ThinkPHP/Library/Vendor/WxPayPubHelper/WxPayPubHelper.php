...
//        parent::__construct($wxPayConfig);
        $this->wxPayConfig = $wxPayConfig;
        $this->curl_timeout = $this->wxPayConfig->curl_timeout;
    }
    ...
    {
        $xml = $this->createXml();
        $this->response = $this->postXmlCurl($xml, $this->url, $this->wxPayConfig->curl_timeout);
    ...
    {
        $xml = $this->createXml();
        $this->response = $this->postXmlSSLCurl($xml, $this->url, $this->wxPayConfig->curl_timeout);
        return $this->response;
    }
...
class NativeCall_pub extends Wxpay_server_pub
{
    ...
    function createXml()
    {
        if ($this->returnParameters["return_code"] == "SUCCESS") {
            $this->returnParameters["appid"] = $this->data['appid'];//公众账号ID
            $this->returnParameters["mch_id"] = $this->data['mch_id'];//商户号
